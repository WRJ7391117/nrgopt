...
async function runPaidCall({ store, owner, jobId = null, operation, currency, budgetKey, providerMissingCode,
  budgetLimitMicro = null, env = process.env, idempotencyKey = `manual:${operation}:${randomUUID()}`, call }) {
...
module.exports = { reserveAmount, automaticCallReserve, usageCharge, runPaidCall };
