...
<head>
  ...
  <script src="/js/intelligence.js?v=20260924-watch-search" defer></script>
</head>
...
function overviewPage() {
  ...
  return page('六国情报全景', `
    ...
    <section class="intel-panel" aria-labelledby="operations-title">
      ...
      <p class="intel-muted">每日安排六国基础搜索，并为最多 5 组关注对象分别搜索支持证据和反证，合计最多 16 组查询（失败重试另计）。关注对象按日轮换，90 天后停止主动搜索并等待复查；未搜到新消息不代表假设被否定。</p>
