...
<head>
  ...
  <script src="/js/intelligence.js?v=20260926-resilience-signals" defer></script>
</head>
...
function overviewPage() {
  ...
  return page('六国情报全景', `
    ...
    <section class="intel-radar-summary" aria-label="情报概况">
      <a href="/intelligence/overview?view=signal"><strong id="radar-trigger-count">0</strong><span>早期信号</span><small>区域变化如何影响能源韧性</small></a>
      ...
      <section class="intel-panel intel-analysis">
        ...
        <div id="extraction-content" hidden>
          ...
          <section id="extraction-classification" class="intel-classification" hidden>
            <h3>业务分类与发生区域</h3><p id="extraction-classification-summary"></p>
