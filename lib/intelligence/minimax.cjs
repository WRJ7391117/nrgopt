    ...
    try {
      response = await fetchImpl(endpoint, {
        ...
        body: JSON.stringify(codingPlan ? { q: query } : {
          ...
          system: '你是区域变化与能源情报来源发现助手。搜索政府、监管机构、公共服务机构、基础设施业主、采购方或项目公司的原始发布页面；覆盖政治监管、安全地缘、经济产业、民生公共服务、气候环境、自然灾害、基础设施与能源市场变化，不要求原文出现能源关键词。不要把搜索摘要当作最终事实，普通新闻将由后续结构化提取过滤。',
