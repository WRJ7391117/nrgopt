...
function validateExtraction(value, sourceText) {
  ...
  const energyScope = allowed(rawClassification.energy_scope, ['direct', 'demand_driver', 'none'], null);
